export const birthdayConfig = {
  ...
  /** ISO date string — birthday at midnight local time */
  ...
  giftBoxes: [
    {
      id: "gift-1",
      label: "Gift #1",
      surprise: "One unlimited hug coupon — redeem anytime, no expiry.",
    },
    {
      id: "gift-2",
      label: "Gift #2",
  ...
  scratchCards: [
    ...
    { message: "I'd choose you in every timeline." },
    { message: "Still crushing on you. Hard." },
  ],
  flipCards: [
  ...
  randomCompliments: [
    "You're ridiculously handsome today.",
    "Did you know you're my favorite human?",
